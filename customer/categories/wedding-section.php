<!-- WEDDING GOWNS SECITON -->
<section class="gown-section" id="gown-wedding" style="scroll-margin-top: 80px;">
            
    <div class="container"  style="display:flex; width: 100%; flex-direction: column;" >
        <div class="section-title" >
            <h2>WEDDING GOWNS</h2>
            <p>Explore our exquisite collection of handcrafted wedding dresses</p>
        </div>
        </div>
    <div class="container-fluid mt-5 px-4" style="margin-top: 10px !important;">
            <div class="row g-4" style="padding: 0 20px 0 20px; margin-top: -10px;">
                    ...
                    <?php
                    $result=mysqli_query($conn,"Select * from gowns where category_id = 2 AND  available  = 1 order by id desc;");
