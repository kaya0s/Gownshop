            ...
            <div class="login_container" style="background-color:whitesmoke;" >
                <div class="card">
                    ...
                    <form action="auth/validateLogin.php" method="POST">
                        ...
                        <div class="g-recaptcha" data-site="<?= htmlspecialchars($siteKey) ?>"></div>
                        <!-- SIGN IN WITH GOOGLE -->    
                    ...
                    <!-- Update the Google Sign-In button to use the generated auth URL -->
                    ...
                    <p>Don't have an account? <a style="color:rgb(5, 61, 151); margin-left: 6px;" href="auth/register.php">Sign up</a></p>
                ...
                <div   class="video-container" style="width: 60vw; background-color: #041623;" >
...
<style>
    ...
    @import url('https://fonts.googleapis.com/css2?family=Aboreto:wght@400;500;600;700&display=swap');
.google-btn {
